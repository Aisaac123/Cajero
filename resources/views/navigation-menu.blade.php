<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <div class="flex ">
                                    <button class="flex text-sm mt-2 font-normal mr-2 text-gray-500 hover:text-black duration-300">
                                            {{ Auth::user()->name }}
                                    </button>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('withdraw.index') }}" :active="request()->routeIs('withdraw.index')">
                {{ __('Withdraw') }}
