                        ...
                        @else
                            @foreach($cards as $card)
                                    <x-secondary-button
                                        ...
                                        {{ !$card->is_blocked
                                            ? 'bg-gradient-to-r from-violet-500 to-violet-800 hover:bg-gradient-to-r hover:from-violet-600 hover:to-violet-900 duration-300 transition'
                                            : 'bg-gradient-to-r from-red-500 to-red-800 hover:bg-gradient-to-r hover:from-red-600 hover:to-red-900 duration-300 transition'  }}
